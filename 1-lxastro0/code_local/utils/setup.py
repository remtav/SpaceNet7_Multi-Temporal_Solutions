...
try:
    ...
    sys.exit("GDAL must be installed to use `gdlutils`. See the documentation "
...
project_name = 'gdlutils'
setup(name='gdlutils',
      version=get_version(),
      description="Geo-Deep-Learning Toolkit",
      classifiers=[
      ...
      author_email='remi.tavon@canada.ca',
